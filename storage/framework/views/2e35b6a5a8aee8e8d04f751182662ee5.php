...
unset($__errorArgs, $__bag); ?>" required>
                        <option value="STARTED" <?php echo e(old('status', $project->status) == 'STARTED' ? 'selected' : ''); ?>><?php echo e(__('Started')); ?></option>
                        <option value="ONHOLD" <?php echo e(old('status', $project->status) == 'ONHOLD' ? 'selected' : ''); ?>><?php echo e(__('On Hold')); ?></option>
...
unset($__errorArgs, $__bag); ?>" multiple>
                        <?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($member->id); ?>" <?php echo e(collect(old('team_members', $project->teamMembers->pluck('id')))->contains($member->id) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\projectmanegement\resources\views/projects/edit.blade.php ENDPATH**/ ?>