<?php $__env->startSection('header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        <h2 class="h4 text-dark">
            <?php echo e(__('Project Creation')); ?>

        </h2>
        <a href="<?php echo e(route('projects.index')); ?>" class="btn btn-warning"><?php echo e(__('Back to List')); ?></a>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?php echo e(route('projects.store')); ?>" method="POST">
                ...
                <!-- Name -->
                <div class="mb-3">
                    <label for="name" class="form-label"><?php echo e(__('Project Name')); ?></label>
...
unset($__errorArgs, $__bag); ?>" required>
                        <option value="STARTED" <?php echo e(old('status') == 'STARTED' ? 'selected' : ''); ?>><?php echo e(__('Started')); ?></option>
                        <option value="ONHOLD" <?php echo e(old('status') == 'ONHOLD' ? 'selected' : ''); ?>><?php echo e(__('On Hold')); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Team Members -->
                <div class="mb-3">
                    <label for="team_members" class="form-label"><?php echo e(__('Team Members')); ?></label>
                    <select name="team_members[]" id="team_members" class="form-select <?php $__errorArgs = ['team_members'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" multiple>
                        <?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($member->id); ?>" <?php echo e(collect(old('team_members'))->contains($member->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Submit Button -->
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary"><?php echo e(__('Save Project')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\projectmanegement\resources\views/projects/create.blade.php ENDPATH**/ ?>