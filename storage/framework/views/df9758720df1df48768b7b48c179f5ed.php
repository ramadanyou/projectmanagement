    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?php echo e(route('tasks.update', $task->id)); ?>" method="POST">
                ...
                <!-- Task Title -->
                <div class="mb-3">
                    <label for="title" class="form-label"><?php echo e(__('Task Title')); ?></label>
...
unset($__errorArgs, $__bag); ?>" required>
                        <option value="TODO" <?php echo e(old('status', $task->status) == 'TODO' ? 'selected' : ''); ?>><?php echo e(__('To Do')); ?></option>
                        <option value="INPROGRESS" <?php echo e(old('status', $task->status) == 'INPROGRESS' ? 'selected' : ''); ?>><?php echo e(__('In Progress')); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('start_date', $task->start_date)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('end_date', $task->end_date)); ?>">
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $task->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Assignees -->
                <div class="mb-3">
                    <label for="assignees" class="form-label"><?php echo e(__('Assignees')); ?></label>
                    <select name="assignees[]" id="assignees" class="form-select <?php $__errorArgs = ['assignees'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" multiple>
                        <?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($member->id); ?>" <?php echo e(collect(old('assignees', $task->assignees->pluck('id')))->contains($member->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Submit Button -->
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary"><?php echo e(__('Update Task')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\projectmanegement\resources\views/tasks/edit.blade.php ENDPATH**/ ?>