<?php $__env->startSection('header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('projects.show', $project->id)); ?>" class="btn btn-warning"><?php echo e(__('Back to Project')); ?></a>
    </div>
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <option value="MEDIUM" <?php echo e(old('priority') == 'MEDIUM' ? 'selected' : ''); ?>><?php echo e(__('Medium')); ?></option>
...
unset($__errorArgs, $__bag); ?>" required>
                        <option value="TODO" <?php echo e(old('status') == 'TODO' ? 'selected' : ''); ?>><?php echo e(__('To Do')); ?></option>
                        <option value="INPROGRESS" <?php echo e(old('status') == 'INPROGRESS' ? 'selected' : ''); ?>><?php echo e(__('In Progress')); ?></option>
...
unset($__errorArgs, $__bag); ?>" multiple>
                        <?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($member->id); ?>" <?php echo e(collect(old('assignees'))->contains($member->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Submit Button -->
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary"><?php echo e(__('Save Task')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projectmanegement\resources\views/tasks/create.blade.php ENDPATH**/ ?>